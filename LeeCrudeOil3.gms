...
val(v,'p3')$DISTIL(v) = 0.85;
val(v,'p4')$DISTIL(v) = 0.2;
val(v,'p5')$DISTIL(v) = 0.5;
val(v,'p6')$DISTIL(v) = 0.8;
val(v,'p7')$DISTIL(v) = 0.3;
...
minProp(v,k) = -INF;
Loop(v$(DISTIL(v) And OUT(v,'r7')), minProp(v,'k1') = 0.25; );
Loop(v$(DISTIL(v) And OUT(v,'r8')), minProp(v,'k1') = 0.45; );
Loop(v$(DISTIL(v) And OUT(v,'r9')), minProp(v,'k1') = 0.75; );

* Maximum operation property
maxProp(v,k) = INF;
Loop(v$(DISTIL(v) And OUT(v,'r7')), maxProp(v,'k1') = 0.35; );
Loop(v$(DISTIL(v) And OUT(v,'r8')), maxProp(v,'k1') = 0.65; );
Loop(v$(DISTIL(v) And OUT(v,'r9')), maxProp(v,'k1') = 0.85; );
